package com.example.root.autofocus_app;
...
public class AutofocusActivity extends Activity
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (classifyPatches){
            ...
            Mat quadrant0 = aux.submat(roi0);
            Mat quadrant1 = aux.submat(roi1);
            Mat quadrant2 = aux.submat(roi2);
            Mat quadrant3 = aux.submat(roi3);
            /** Save images */
